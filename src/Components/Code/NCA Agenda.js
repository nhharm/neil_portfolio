...
<a className="linkOut" target="_blank" rel="noopener noreferrer" href="https://memberportal.nationalclub.org/mpage/NCAAgendaHome">The final design can be seen here</a> and shows the website structure. This site was coded in PHP, CSS, HTML, Markdown and JQuery/JavaScript. Our communications team sent a similarly designed email newsletter that worked in conjunction with the site. Note, the site in the link above does not include all links (library, previous issues, contacts) due to sections being behind a membership paywall.
